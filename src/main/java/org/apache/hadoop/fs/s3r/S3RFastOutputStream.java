...
public class S3RFastOutputStream extends OutputStream {

  private static final Logger LOG = S3RFileSystem.LOG;
  private final String key;
  private final String bucket;
  private final AmazonS3Client client;
  private final int partSize;
  private final int multiPartThreshold;
  private final S3RFileSystem fs;
   ...
   * @throws IOException
   */
  public S3RFastOutputStream(AmazonS3Client client, S3RFileSystem fs,
