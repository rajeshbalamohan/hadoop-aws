...
public class S3ROutputStream extends OutputStream {
  ...
  public S3ROutputStream(Configuration conf, TransferManager transfers,
      S3RFileSystem fs, String bucket, String key, Progressable progress,
